...
# OCR Auto Installation Script for Linux (Fully Automated)
# This script automates the entire installation without user interaction

set -e  # Exit on error

echo "=========================================="
echo "OCR System Auto Installation Script"
echo "=========================================="
echo ""
...
then
    ...
    echo "Node.js is not installed. Installing from $NODE_TARBALL..."
...
echo ""
echo "To check if auto-startup is enabled:"
echo "  pm2 startup"
echo ""
